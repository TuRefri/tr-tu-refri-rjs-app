...
const initialForm : initialFormProp = {
    id: 0,
    name: '',
    store_id: 0,
    description: '',
...
export default function ModalCreatePromotion({ handleCloseCreatePromotionModal, selectedStoreForPromotion }: ModalCreatePromotionProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        userPromotions.push(form);
        sessionStorage.setItem("promotions_user", JSON.stringify(userPromotions));
        ...
        >
            ...
            <section className='flex flex-col justify-start w-full'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col'>
                    ...
                    ></textarea>
                    <label className='text-md text-gray-600'>Fecha de Inicio</label>
                    <input
                        type="date"
                        name="initial_date"
                    ...
                    <label className='text-md text-gray-600'>Fecha de Fin</label>
                    <input
                        type="date"
                        name="end_date"
                        value={form.end_date}
