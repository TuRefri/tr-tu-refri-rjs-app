...
return (
    <motion.div
            ...
            className='overflow-y-scroll no-scrollbar  py-12 px-8 z-30 cursor-pointer relative w-[95%] h-full flex flex-col items-center rounded-xl shadow-md bg-[#fdfcfc]  '
        >
        ...
        <div className='w-full border-b'/>
        <p className='text-sm font-light text-center p-1 text-wrap text-blue-500'>{data?.address}</p><div className='w-full border-b'/>
        <div className='w-full border-b'/>
        <p className='text-sm font-light text-center p-1 text-wrap font-medium'>{data?.schedule[day]}</p>
        <div className='w-full border-b'/>
        <p className='text-sm font-light text-center p-1 text-wrap'>{data?.description}</p>
        <div className='w-full border-b'/>
        
        <p className='relative w-full rounded-full bg-green-600 text-white font-semibold text-lg mt-3 text-center py-2 cursor-pointer'>
        ...
        <p className='relative w-full rounded-full bg-gray-300 font-semibold text-lg text-gray-700 m-2 text-center py-2 cursor-pointer'>
            {data?.phone}
        </p>
